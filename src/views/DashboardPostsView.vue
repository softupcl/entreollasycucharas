...
<template>
  <div class="p-6">
    ...
    <!-- Posts table -->
    <div v-else-if="!loading && posts.length > 0" class="bg-white shadow rounded-lg">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="post in posts" :key="post.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="w-32 h-8 rounded-full flex items-center justify-center">
                  <span
                    :class="
                      categories.find((c) => c.id === post.category)?.color + ' text-white text-sm'
                    "
                  >
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                ...
                <button @click="handleDelete(post.id)" class="text-red-600 hover:text-red-900">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
